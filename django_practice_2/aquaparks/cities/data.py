...
aquapark_3.city.add(city_)
aquapark_4.city.add(city_)
...
aquapark_17.city.add(city_)
aquapark_18.city.add(city_)
aquapark_19.city.add(city_)
aquapark_20.city.add(city_)