...
aquapark_.save()
aquapark_5.city.add(city_3)
aquapark_.save()
aquapark_6.city.add(city_3)
aquapark_.save()
aquapark_7.city.add(city_4)
aquapark_.save()
aquapark_8.city.add(city_4)
aquapark_.save()
aquapark_9.city.add(city_5)
aquapark_.save()
aquapark_10.city.add(city_5)
aquapark_.save()
aquapark_11.city.add(city_6)
aquapark_.save()
aquapark_12.city.add(city_6)
aquapark_.save()
aquapark_13.city.add(city_7)
aquapark_.save()
aquapark_14.city.add(city_7)
aquapark_.save()
aquapark_15.city.add(city_8)
aquapark_.save()
aquapark_16.city.add(city_8)
aquapark_16.save()
