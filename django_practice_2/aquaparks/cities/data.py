...
city_ = City.objects.all()[2]
city_ = City.objects.all()[3]
city_ = City.objects.all()[4]
city_ = City.objects.all()[5]
city_ = City.objects.all()[6]
city_ = City.objects.all()[7]
city_ = City.objects.all()[8]
city_ = City.objects.all()[9]